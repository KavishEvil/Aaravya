  ...
  if (result?.ok) {
    return (
      <div className="rounded-2xl border border-brand/30 bg-accent p-8 text-center">
        ...
        <p className="mt-4 font-heading text-xl font-semibold text-accent-foreground">
          Request received
        </p>
      ...
      <div>
        ...
        <Controller
          ...
          render={({ field }) => (
            ...
            >
              <label className="flex cursor-pointer items-center gap-2 rounded-xl border border-border p-3 text-sm has-[[data-checked]]:border-brand has-[[data-checked]]:bg-accent">
